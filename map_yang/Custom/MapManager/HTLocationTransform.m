...
@implementation HTLocationTransform
...
- (CLLocationCoordinate2D)transformFromGPSToGD {
    CLLocationCoordinate2D coor = [HTLocationTransform transformFromWGSToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
    return coor;
}

- (CLLocationCoordinate2D)transformFromGDToBD {
    CLLocationCoordinate2D coor = [HTLocationTransform transformFromGCJToBaidu:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
    return coor;
}

- (CLLocationCoordinate2D)transformFromBDToGD {
    CLLocationCoordinate2D coor = [HTLocationTransform transformFromBaiduToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
    return coor;
}

- (CLLocationCoordinate2D)transformFromGDToGPS {
    CLLocationCoordinate2D coor = [HTLocationTransform transformFromGCJToWGS:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
    return coor;
}

- (CLLocationCoordinate2D)transformFromBDToGPS {
    //先把百度转化为高德
    CLLocationCoordinate2D start_coor = [HTLocationTransform transformFromBaiduToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
    CLLocationCoordinate2D end_coor = [HTLocationTransform transformFromGCJToWGS:CLLocationCoordinate2DMake(start_coor.latitude, start_coor.longitude)];
    return end_coor;
}
